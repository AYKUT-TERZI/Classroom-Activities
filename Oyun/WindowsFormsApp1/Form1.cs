...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            bool kazandiMi = pnlKutu.Bounds.IntersectsWith(lblFinish.Bounds);
            ...
            if (kazandiMi)
            {
                ...
                DialogResult dr = MessageBox.Show("Tekrar oynamak ister misiniz?", "Kazandınız!", MessageBoxButtons.YesNo);

                if(dr == DialogResult.Yes)
                {
                    pnlKutu.Location = new Point(100, 227);
                }
                else
                {
                    Application.Exit();
            ...
            if (kaybettiMi)
            {
                ...
                DialogResult dr = MessageBox.Show("Tekrar oynamak ister misiniz?", "Kaybettiniz!", MessageBoxButtons.YesNo);
